...
document
    ...
    .addEventListener('submit', function(e) {
        ...
        const emailErr =
            document.getElementById('loginEmailErr');

        const pass =
            document.getElementById('loginPassword');

        const passErr =
            document.getElementById('loginPasswordErr');
...
document
    ...
    .addEventListener('submit', function(e) {
        ...
        const sport =
            document.getElementById('favSport');

        const sportErr =
            document.getElementById('favSportErr');

        const terms =
            document.getElementById('termsCheck');

        const termsErr =
            document.getElementById('termsCheckErr');
