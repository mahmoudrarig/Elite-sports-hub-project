...
if (productReviewText && reviewCharacterCount) {
    productReviewText.addEventListener("input", function () {
        const currentLength = productReviewText.value.length;
...
if (productReviewForm) {
    productReviewForm.addEventListener(
        ...
        function (event) {
            ...
            /* NEW: reset character counter after submit */
            if (reviewCharacterCount) {
                reviewCharacterCount.textContent =
                    "0 / 500 characters";
            }
